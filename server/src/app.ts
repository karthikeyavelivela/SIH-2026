...
import { paymentRouter, adminPaymentRouter } from './routes/payment.routes';
...
app.use('/api/admin/service-categories', adminServiceCategoryRouter);
app.use('/api/checkpoints', checkpointRouter);
app.use('/api/admin/checkpoints', adminCheckpointRouter);
