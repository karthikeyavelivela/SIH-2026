...
export default function WarehouseHubError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return <ErrorBoundaryContent error={error} reset={reset} homeHref="/warehouse-hub/dashboard" />;
}
