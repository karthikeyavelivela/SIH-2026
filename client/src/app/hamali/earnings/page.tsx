...
export default function HamaliEarningsPage() {
  ...
  return (
    <div className="min-h-screen bg-fy-bone pb-24">
      ...
      <div className="rounded-card bg-fy-green text-white p-6 mb-4">
      ...
      {!!data?.incentiveTotal && (
        <div className="flex items-center gap-3 mb-6 px-4 py-3 rounded-card bg-fy-green/10 text-sm text-fy-green">
