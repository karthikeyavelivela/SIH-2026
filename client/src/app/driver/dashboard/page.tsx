...
export default function DriverDashboardPage() {
  ...
  return (
    <div className="max-w-lg mx-auto px-5 pt-6">
      ...
      {activeJob ? (
        <Link href={`/driver/active-job/${activeJob._id}`} className="block mb-6">
          <div className="rounded-lg bg-primary-600 text-white p-5 shadow-lg hover:shadow-glow-primary hover:-translate-y-0.5 transition-all duration-base">
